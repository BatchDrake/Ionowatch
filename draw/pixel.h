...
static inline void
box (display_t *display, int ax, int ay, int bx, int by, Uint32 color)
{
  line (display, ax, ay, ax, by, color);
  line (display, ax, ay, bx, ay, color);
  
  line (display, ax, by, bx, by, color);
  line (display, bx, ay, bx, by, color);
}
