...
{
      13,     0,    -1,     3,    -1,    14,    -1,    13,     3,    -1,
       4,     7,    10,    11,     9,     5,    14,     6,    14,     8,
      -1,    10,    -1
};
...
{
  "$end", "error", "$undefined", "EOL", "IF", "THEN", "ELSE",
  "OPENING_BRACKET", "CLOSING_BRACKET", "NUMERIC", "TOKEN", "GTE",
  "$accept", "root_decision", "decision", 0
};
#endif
...
{
       1,     2,     2,     7,     9,    11,     8,     3,     3,     6,
      12,    13,    10,    15,    14,    16
};

static const yytype_uint8 yycheck[] =
{
       3,     4,     4,     0,    10,     9,     3,    10,    10,     7,
       5,    12,    11,    14,     6,     8
};
...
#line 54 "id3syntax.y"
    { (yyval) = temp_tree; 
                               decision_tree_set_root (temp_tree, (yyvsp[(1) - (1)])); }
    break;
...
/* Line 1455 of yacc.c  */
#line 62 "id3syntax.y"
    { (yyval) = threshold_node_new (input_param_lookup_autoalloc (temp_tree, (yyvsp[(3) - (10)])), *(float *) (yyvsp[(5) - (10)]));
                               ((struct node *) (yyval))->true_node  = (yyvsp[(7) - (10)]);
                               ((struct node *) (yyval))->false_node = (yyvsp[(9) - (10)]);
...
/* Line 1455 of yacc.c  */
#line 70 "id3syntax.y"
    { (yyval) = leaf_node_new (output_lookup_autoalloc (temp_tree, (yyvsp[(1) - (1)]))); 
                               free ((yyvsp[(1) - (1)]));
                             }
    break;
